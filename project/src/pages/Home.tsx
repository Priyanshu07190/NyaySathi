      ...
      <div className="text-center mb-16">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
            <span className="text-blue-600">{content.appName}</span> {content.welcomeTitle.replace(content.appName, '').replace('में ', '').replace('तে ', '').replace('లో ', '').replace('ಲ್ಲಿ ', '').replace('এ ', '').replace('માં ', '')}
          </h1>
